...
const ResultPage: FC<IResult> = ({ bmr, tdee, weighDifference, goalDate, reset }) => {
    ...
    const calPerDay = useMemo(()=>calculation+tdee_calories,[calculation, tdee_calories]);
    ...
    return (
        <div>
            <div onClick={handleDivClick} className="flex flex-col justify-center items-center mb-1.5">
                <h1 className="text-3xl mb-2">Your BMR: {bmr.toFixed(2)}</h1>
            ...
            <div onClick={handleDiv2Click} className="flex flex-col justify-center items-center my-1.5">
                <h1 className="text-3xl mb-2">Your TDEE calories: {tdee_calories.toFixed(2)}</h1>
                <h2
                    className={`${
                ...
                { goalDate!==0 &&
                <div onClick={handleDiv3Click} className="flex flex-col justify-center items-center my-1.5">
                    <h1 className="text-3xl mb-2">Your calories per day to get the weight: {calPerDay.toFixed(2)}</h1>
                    <h2
                        className={`${
